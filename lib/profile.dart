// ignore_for_file: avoid_unnecessary_containers, prefer_const_constructors, sort_child_properties_last, unnecessary_new
...
class MapScreenState extends State<profile>
  ...
  Widget build(BuildContext context) {
    first_namec.text = widget.first_name + " " + widget.last_name;
                            ...
                            new Container(
                                ...
                                decoration: new BoxDecoration(
                                  ...
                                  image: new DecorationImage(
                                    image: new ExactAssetImage(widget.picture),
                                    fit: BoxFit.cover,
                                  ),
                                )),
                          ],
